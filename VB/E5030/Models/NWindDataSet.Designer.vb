...
Partial Public Class NWindDataSet
    ...
    Partial Public Class ProductsDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddProductsRow(ByVal ProductName As String, ByVal UnitPrice As Decimal, ByVal UnitsInStock As Short, ByVal EAN13 As String, ByVal parentCategoriesRowByCategoriesProducts As CategoriesRow) As ProductsRow
            Dim rowProductsRow As ProductsRow = CType(Me.NewRow,ProductsRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, ProductName, UnitPrice, UnitsInStock, EAN13, Nothing}
            If (Not (parentCategoriesRowByCategoriesProducts) Is Nothing) Then
                columnValuesArray(5) = parentCategoriesRowByCategoriesProducts(0)
            End If
...
Namespace NWindDataSetTableAdapters
    ...
    Partial Public Class ProductsTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Products` SET `ProductName` = ?, `CategoryID` = ?, `UnitPrice` = ?, `Unit"& _ 
                "sInStock` = ?, `EAN13` = ? WHERE ((`ProductID` = ?))"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ProductID, ProductName, CategoryID, UnitPrice, UnitsInStock, EAN13 FROM Pr"& _ 
                "oducts"
        ...
        Public Overloads Overridable Function Update(ByVal ProductName As String, ByVal CategoryID As Global.System.Nullable(Of Integer), ByVal UnitPrice As Global.System.Nullable(Of Decimal), ByVal UnitsInStock As Global.System.Nullable(Of Short), ByVal EAN13 As String, ByVal Original_ProductID As Integer) As Integer
            ...
            If (UnitsInStock.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(3).Value = CType(UnitsInStock.Value,Short)
            Else
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(4).Value = CType(EAN13,String)
            End If
    ...
    Partial Public Class CategoriesTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand = New Global.System.Data.OleDb.OleDbCommand()
            Me._adapter.DeleteCommand.Connection = Me.Connection
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Categories` WHERE ((`CategoryID` = ?))"
            Me._adapter.DeleteCommand.CommandType = Global.System.Data.CommandType.Text
